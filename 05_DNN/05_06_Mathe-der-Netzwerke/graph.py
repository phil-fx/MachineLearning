...
# Save Path
log_dir = os.path.abspath("/home/phil/MachineLearning/logs/computation/")
...
model.layers[2].set_weights([np.array([[1.250]]), np.array([0.125])]) # [2] weil [1] ist die relu [2] ist W+X+b
