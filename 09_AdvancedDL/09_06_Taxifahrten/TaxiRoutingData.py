...
class TAXIROUTING:
    def __init__(self, excel_file_path):
        ...
        self.y = self.df['y']
        self.x = self.x.to_numpy()  # referenz die sowieso schon im df sind
...
if __name__ == '__main__':
    ...
    print(taxi_data.train_size, taxi_data.test_size)
    print(taxi_data.num_features, taxi_data.num_targets)
    ...
    df.hist(bins=50, figsize=(20,15))   # pandas funktion die ein histogram ausgibt, bins ist die aufteilung zwoschen min und may
    plt.show()